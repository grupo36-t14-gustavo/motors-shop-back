...
const getPayloadUtil = (request) => {
    ...
    throw new errorHandler_util_1.AppError("Access token was not provided", constants_1.statusError.UNAUTHORIZED);
};
exports.getPayloadUtil = getPayloadUtil;
